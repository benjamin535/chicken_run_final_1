...
public class PlayerController : MonoBehaviour
{
    ...
    public AudioClip hitSoundEffect = null; // Sound effect for getting hit

    private Renderer renderer = null;
    private bool isVisible = false;
    private AudioSource audioSource = null; // Audio source component
    ...
    public void GetHit()
    {
        ...
        if (hitSoundEffect != null && audioSource != null) // Play sound effect 
        {
